...
import { faXmark, faEnvelope, faLock, faUser, faShieldHalved } from '@fortawesome/free-solid-svg-icons';
        ...
        >
          ...
          <div className="p-8">
            ...
            <p className="text-white/60 text-sm mb-6">
              {step === 'otp' ? 'Enter the OTP sent to your email.' : 'Sign in to access your saved trips and special offers.'}
            </p>
            ...
            {step === 'credentials' ? (
              ...
              <form onSubmit={handleOtpSubmit} className="space-y-4">
                <div>
                  <label className="block text-white/70 text-sm mb-1">One-Time Password</label>
                  <div className="relative">
